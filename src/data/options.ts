...
export const options: Option[] = [
  ...
  },
  {
    ...
    category: "shutters",
    description:
      "Боковые панели из алюминия с порошковым покрытием. Доступны четыре варианта открывания: фиксированные, раздвижные, складные и распашные. Обеспечивают защиту от ветра и приватность периметра.",
    features: [
    ...
    variants: ["Фиксированные", "Раздвижные", "Складные", "Распашные"],
    ...
    seo: {
      ...
      description:
        "Алюминиевые боковые панели для пергол UOGEL: фиксированные, раздвижные, складные и распашные. Защита и приватность для террас. Расчёт по модели.",
    },
  },
  {
    id: "ceiling-fan",
    ...
    category: "climate",
    description:
      "Потолочный вентилятор, интегрированный в конструкцию перголы. Создаёт движение воздуха и снижает ощущаемую температуру в жаркую погоду.",
    features: [
    ...
    seo: {
      ...
      description:
        "Потолочный вентилятор для пергол UOGEL: охлаждение и циркуляция воздуха. Доступен для серий A13, C10, C7. Расчёт по конфигурации.",
    },
  },
  {
    ...
    category: "climate",
    description:
      "Инфракрасный обогреватель, встраиваемый в конструкцию перголы. Позволяет использовать террасу в прохладное время года без внешнего отопительного оборудования.",
    features: [
      "Инфракрасный нагрев",
      "Интеграция в профиль перголы",
    ...
    seo: {
      ...
      description:
        "Инфракрасный обогреватель для пергол UOGEL: продление сезона для террасы. Доступен для серий A13, C10, C7. Расчёт по конфигурации.",
    },
  },
  {
