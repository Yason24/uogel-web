      ...
      <section className="bg-stone-50 py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {featuredOptions.map((opt) => (
              <Link
                ...
                className="group rounded-2xl border border-stone-200 bg-white p-6 transition hover:-translate-y-0.5 hover:shadow-md hover:shadow-stone-200"
              >
                <h3 className="text-base font-semibold text-stone-950 group-hover:text-stone-700">
                  {opt.title}
                </h3>
                <p className="mt-2 text-sm leading-6 text-stone-600">
                  {opt.subtitle}
          ...
          <div className="mt-8">
            <Link
              href="/options"
              className="text-sm font-semibold text-stone-700 underline underline-offset-4 hover:text-stone-950"
            >
